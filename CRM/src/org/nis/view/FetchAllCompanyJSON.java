...
/**
 * Servlet implementation class FetchAllCompanyJSON
 */
@WebServlet("/FetchAllCompanyJSON")
public class FetchAllCompanyJSON extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FetchAllCompanyJSON() {
        super();

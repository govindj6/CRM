...
public class EmployeesLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<br><div class='col-lg-5'><form class='form-signin' action=CheckEmployeesLogin method=post>");
		out.println("        <h2 class='form-signin-heading'>Employees Login</h2>");
		out.println("        <div class='login-wrap'>");
		out.println("            <input type='text' class='form-control' name=eid placeholder='Employee ID' autofocus>");

...
/**
 * Servlet implementation class SCChangePassword
 */
@WebServlet("/SCChangePassword")
public class SCChangePassword extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SCChangePassword() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form action=CheckServiceCenterPassword method=post>");
		 
		out.print("<table class='table table-bordered'>");
		out.println("<caption><b><i>Change Password</i></b></caption>");		
		
		out.println("<tr><td><b><i>ServiceCenter Id:</i></b></td>");

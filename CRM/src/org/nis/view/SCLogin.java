...
/**
 * Servlet implementation class SCLogin
 */
@WebServlet("/SCLogin")
public class SCLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<br><div class='col-lg-5'><form class='form-signin' action=CheckSCLogin method=post>");
		out.println("        <h2 class='form-signin-heading'>Service Center Login</h2>");
		out.println("        <div class='login-wrap'>");
		out.println("            <input type='text' class='form-control' name=sid placeholder='SC ID' autofocus>");
		out.println("            <input type='password' class='form-control' name=pwd placeholder='Password'>");

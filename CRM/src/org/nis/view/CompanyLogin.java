...
public class CompanyLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<br><div class='col-lg-5'><form class='form-signin' action=CheckCompanyLogin method=post>");
		out.println("        <h2 class='form-signin-heading'>Company Login</h2>");
		out.println("        <div class='login-wrap'>");
		out.println("            <input type='text' class='form-control' name=cid placeholder='Admin ID' autofocus>");
		out.println("            <input type='password' class='form-control' name=email placeholder='Password'>");

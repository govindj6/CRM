...
public class EmployeesHome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/////////////////
		 ...
		 String nav="<i>"+E.getDesignation()+":"+E.getEmployeename()+"["+E.getEmployeeid()+"]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+ltime+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=EmployeeLogout class='btn btn-danger btn-xs'>Logout</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=images/employee/"+E.getPhotograph()+" width=30 height=30 class='img-thumbnail'></i>";		 
		 out.println(nav);
		}
		 catch(Exception e)
		 {
...
out.println("<li class='sub-menu'><a href=ComplaintView target=mw><i class='fa fa-laptop'></i><span>Complaint Register</span></a>");
out.println("</li>");
		 
out.println("<li class='sub-menu'><a href='EmployeeChangePassword' target=mw><i class='fa fa-laptop'></i><span>Change Password</span></a>");
out.println("</li>");
out.println("<li class='sub-menu'><a href='ComplaintFollowUp' target=mw><i class='fa fa-laptop'></i><span>Follow Up Complaint</span></a>");
out.println("</li>");
		 ...
		 out.println("<center>EMPLOYEES HOME</center><hr>");

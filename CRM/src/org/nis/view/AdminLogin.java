...
public class AdminLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<br><div class='col-lg-5'><form class='form-signin' action=CheckAdminLogin method=post>");
		out.println("        <h2 class='form-signin-heading'>Admin Login</h2>");
		out.println("        <div class='login-wrap'>");
		out.println("            <input type='text' class='form-control' name=aid placeholder='Admin ID' autofocus>");
